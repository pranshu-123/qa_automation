...
public class InfluxDBUtils {
    ...
    public static Map<String, Object> getDataToPushForInflux(ITestResult result,
        ...
        data.put(ConfigConstants.IrisConfig.IRIS_BUILD, prop.getProperty(ConfigConstants.IrisConfig.IRIS_BUILD));
        data.put(ConfigConstants.IrisConfig.IRIS_VERSION, prop.getProperty(ConfigConstants.IrisConfig.IRIS_VERSION));
        data.put(InfluxMetricsConstants.BATCH_ID, DateUtils.convertMilliSecToISO(EXECUTION_ID));
        data.put(InfluxMetricsConstants.URL, prop.getProperty(ConfigConstants.IrisConfig.URL));
