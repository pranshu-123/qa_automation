...
public class PurchaseOrderPageObject {
	...
	@FindBy(xpath="//dx-drop-down-box[contains(@displayexpr,'itemNo')]")
	public WebElement itemDropdown;
	
	@FindBy(xpath="(//div[contains(text(),'Item No')]/../../../../../../following-sibling::div//table)[3]//tr[1]/td[1]")
	public WebElement item;
	
	@FindBy(xpath="(//div[contains(text(),'Order Qty')]/../../../../../../following-sibling::div//table)[1]//tr[1]/td//div/div/input")
	public WebElement orderQty;

	@FindBy(xpath="(//div[contains(text(),'Purchase')]/../../../../../../following-sibling::div//table)[1]//tr[1]/td//div/div/input")
	public WebElement purchasePrice;

	@FindBy(xpath="(//div[contains(text(),'Line')]/../../../../../../following-sibling::div//table)[1]//tr[1]/td[9]")
