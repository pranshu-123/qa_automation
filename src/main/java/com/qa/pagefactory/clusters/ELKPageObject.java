...
public class ELKPageObject {
  @FindBy(xpath = "//li[@class=\"active\"]/ul[@class=\"sub-menu\"]/li/a/span[contains(text(),'Elasticsearch')]")
  ...
  @FindBy(xpath = "//li[@class='active']/ul[@class='sub-menu']/li/a/span[contains(text(),'Logstash')]")
  public WebElement logstashTab;

  @FindBy(xpath = "//li[@class='active']/ul[@class='sub-menu']/li/a/span[contains(text(),'Kibana')]")
