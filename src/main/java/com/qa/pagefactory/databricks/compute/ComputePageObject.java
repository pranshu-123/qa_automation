...
public class ComputePageObject {
	...
	public List<WebElement> statusCount;	
	...
	@FindBy(xpath = "//button[contains(text(),'Spark')]")
	...
	@FindBy(xpath = "//tbody[@id='DBClustersListAll-body']/tr")
	public List<WebElement>  jobRunValuesRows;
	
	@FindBy(xpath = "//input[@class='current-page invalid']/..")
	...
	@FindBy(xpath = "//a[contains(text(),'Tags')]/../following-sibling::div//label")
	public List<WebElement>  tagKeyLabels;
