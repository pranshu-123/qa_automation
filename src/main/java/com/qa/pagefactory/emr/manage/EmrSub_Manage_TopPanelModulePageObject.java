package com.qa.pagefactory.emr.manage;
...
public class EmrSub_Manage_TopPanelModulePageObject {
     ...
     */
    public EmrSub_Manage_TopPanelModulePageObject(WebDriver driver) {
