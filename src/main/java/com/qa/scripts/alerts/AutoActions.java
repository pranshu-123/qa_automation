...
public class AutoActions {
	...
	public void selectTriggerCondition(String triggerConditionAppType){
		...
		for(int i=0; i< allTriggerCondition ; i++){
			if(newAutoActionPolicyPageObject.selectTriggerConditions.get(i).getText().contains(triggerConditionAppType)){
	...
	public void selectRefineScope(String scope){
		...
		for(int i=0; i<allScopeCount-1 ; i++){
			if(newAutoActionPolicyPageObject.selectRefineScopeList.get(i).getText().contains(scope)){
				waitExecuter.sleep(1000);
	...
	public boolean validateDefaultAllUserScopeChkBox(String type){
		waitExecuter.sleep(1000);
		if(driver.findElement(By.xpath(String.format(newAutoActionPolicyPageObject.allUserChkBox, type))).isSelected()){
			return true;
		}
		return false;
	}

	public boolean validateDefaultOnlyScopeChkBox(String type){
		waitExecuter.sleep(1000);
		if(driver.findElement(By.xpath(String.format(newAutoActionPolicyPageObject.onlyUserChkBox, type))).isSelected()){
			return true;
		}
		return false;
	}

	public boolean validateDefaultAlwaysScopeChkBox(String type){
		waitExecuter.sleep(1000);
		if(driver.findElement(By.xpath(String.format(newAutoActionPolicyPageObject.alwaysChkBox, type))).isSelected()){
			return true;
		}
		return false;
	}

	public void clickScopeChkBox(String chkBoxName, String type){
		waitExecuter.sleep(2000);
		if(chkBoxName.equals("only")){
			MouseActions.clickOnElement(driver, driver.findElement(By.xpath(String.format(newAutoActionPolicyPageObject.onlyUserChkBox, type))));
		}else if(chkBoxName.equals("except")){
			MouseActions.clickOnElement(driver, driver.findElement(By.xpath(String.format(newAutoActionPolicyPageObject.exceptUserChkBox, type))));
		}else if(chkBoxName.equals("all")){
			MouseActions.clickOnElement(driver, driver.findElement(By.xpath(String.format(newAutoActionPolicyPageObject.allUserChkBox, type))));
		}else if(chkBoxName.equals("daily")){
			MouseActions.clickOnElement(driver, driver.findElement(By.xpath(String.format(newAutoActionPolicyPageObject.dailyChkBox, type))));
		}
		else{
