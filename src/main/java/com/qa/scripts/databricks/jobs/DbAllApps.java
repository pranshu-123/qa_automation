...
import com.qa.pagefactory.databricks.DbSubTopPanelModulePageObject;
...
public class DbAllApps {
    private static final Logger LOGGER = Logger.getLogger(DbAllApps.class.getName());
    private final WaitExecuter waitExecuter;
    private final WebDriver driver;
    private final ApplicationsPageObject applicationsPageObject;
    private final Actions action;
    private final DbSubTopPanelModulePageObject dbSubTopPanelModulePageObject;
    ...
    public DbAllApps(WebDriver driver) {
        ...
        dbSubTopPanelModulePageObject = new DbSubTopPanelModulePageObject(driver);
