...
public class OM_DeleteExistingLineItem extends MainAccelerator{

	private static final Logger LOGGER = Logger.getLogger(OM_DeleteExistingLineItem.class.getName());
