...
public class PS_CreateNewPackingSlipOrder extends MainAccelerator{

	private static final Logger LOGGER = Logger.getLogger(PO_AddLineItem.class.getName());


	@Test(groups = Categories.PACKING_SLIP)
	public void TC_PS_21_createNewPackingSlip() {
		test = extent.createTest("TC_PS_21_createNewPackingSlip", "Verify Buc Field");
		test.assignCategory("PackingSlip");
		Log.startTestCase("TC_PS_21_createNewPackingSlip");
		...
		test.log(Status.PASS, "New Packing Slip created");
	}
