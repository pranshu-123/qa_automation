...
public class PS_DeletePackingSlipLineItems extends MainAccelerator{

	private static final Logger LOGGER = Logger.getLogger(PO_AddLineItem.class.getName());


	@Test(groups = Categories.PACKING_SLIP)
	public void TC_PS_24_deletePackingSlipLineItems() {
		test = extent.createTest("TC_PS_24_deletePackingSlipLineItems", "Delete Packing Slip Line Items");
		test.assignCategory("PackingSlip");
		Log.startTestCase("TC_PS_24_deletePackingSlipLineItems");
		...
		packingSlipWorkflow.deletePackingSlipLineItems();
		test.log(Status.PASS, "Packing Slip line items deleted");
	}
