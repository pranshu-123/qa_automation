...
public class PS_UpdatePackingSlipOrder extends MainAccelerator{

	private static final Logger LOGGER = Logger.getLogger(PO_AddLineItem.class.getName());


	@Test(groups = Categories.PACKING_SLIP)
	public void TC_PS_23_updatePackingSlip() {
		test = extent.createTest("TC_PS_23_updatePackingSlip", "Packing Slip update");
		...
		test.log(Status.PASS, "Packing Slip Updated");
	}
