...
public class PS_VerifyCustomerFields extends MainAccelerator{

	private static final Logger LOGGER = Logger.getLogger(PO_AddLineItem.class.getName());


	@Test(groups = Categories.PACKING_SLIP)
	public void TC_PS_04_05_06_verifyCustomerFieldsAreReadOnly() {
		test = extent.createTest("TC_PS_04_05_06_verifyCustomerFieldsAreReadOnly", "Verify Readonly field");
		...
		packingSlipWorkflow.verifyCustomerFields();
		test.log(Status.PASS, "Customer Name, No and PONO is read-only");
	}
