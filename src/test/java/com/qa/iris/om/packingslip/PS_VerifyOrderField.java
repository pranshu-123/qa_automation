...
public class PS_VerifyOrderField extends MainAccelerator{

	private static final Logger LOGGER = Logger.getLogger(PO_AddLineItem.class.getName());


	@Test(groups = Categories.PACKING_SLIP)
	public void TC_PS_01_02_verifyOrderField() {
		test = extent.createTest("TC_PS_01_02_verifyOrderField", "Verify Order Field");
		test.assignCategory("PackingSlip");
		Log.startTestCase("TC_PS_01_02_verifyOrderField");
		...
		packingSlipWorkflow.validateLineItemsListed();
		test.log(Status.PASS, "Order field verified successfully");
	}
