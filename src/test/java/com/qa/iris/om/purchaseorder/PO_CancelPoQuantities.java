...
public class PO_CancelPoQuantities extends MainAccelerator{

	private static final Logger LOGGER = Logger.getLogger(PO_CancelPoQuantities.class.getName());


	@Test(groups = Categories.PURCHASE_ORDER)
	public void TC_PO_05_cancelPoQuantities() {
		test = extent.createTest("TC_PO_05_cancelPoQuantities", "Cancel PO Qunatites");
		test.assignCategory("PurchaseOrder");
		Log.startTestCase("TC_PO_05_cancelPoQuantities");
