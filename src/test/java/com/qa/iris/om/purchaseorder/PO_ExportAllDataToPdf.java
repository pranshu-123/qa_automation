...
public class PO_ExportAllDataToPdf extends MainAccelerator{

	private static final Logger LOGGER = Logger.getLogger(PO_ExportAllDataToPdf.class.getName());


	@Test(groups = Categories.PURCHASE_ORDER)
	public void TC_PO_15_exportToPdf() {
		test = extent.createTest("TC_PO_15_exportToPdf", "Create New Order");
		test.assignCategory("PurchaseOrder");
		Log.startTestCase("TC_PO_15_exportToPdf");
		...
		purchaseManagementWorkflow.generateReports("pdf");
