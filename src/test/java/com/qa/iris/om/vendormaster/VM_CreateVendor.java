...
public class VM_CreateVendor extends MainAccelerator{

	private static final Logger LOGGER = Logger.getLogger(VM_CreateVendor.class.getName());


	@Test(groups = Categories.PURCHASE_ORDER)
	public void TC_VM_01_createNewVendor() {
		test = extent.createTest("TC_VM_01_createNewVendor", "Create New Vendor");
		test.assignCategory("VendorMaster");
		Log.startTestCase("TC_VM_01_createNewVendor");
		...
		vendorMasterWorkflow.createVendor("vendormaster");
