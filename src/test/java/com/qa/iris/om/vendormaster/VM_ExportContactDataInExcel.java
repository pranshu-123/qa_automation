...
public class VM_ExportContactDataInExcel extends MainAccelerator{

	private static final Logger LOGGER = Logger.getLogger(VM_ExportContactDataInExcel.class.getName());
	...
	public void TC_VM_08_exportContactsDataInPdf() {
		...
		vendorMasterWorkflow.generateReports("Excel");
