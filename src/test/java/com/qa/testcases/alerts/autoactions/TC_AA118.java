...
public class TC_AA118  extends BaseClass {
    ...
    @Test(dataProvider = "clusterid-data-provider",description="P1-Verify that the user can select only a few clusters, save the auto action.")
    public void validateOnlyCluster(String clusterId) {
        ...
        Assert.assertFalse(aa.validateDefaultOnlyScopeChkBox(scope), "Check box 'only' in refine scope is not checked");
