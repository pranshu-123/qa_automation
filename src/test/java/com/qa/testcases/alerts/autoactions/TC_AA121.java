...
@Marker.Alerts
@Marker.All
public class TC_AA121 extends BaseClass {

    private static final Logger logger = Logger.getLogger(TC_AA121.class.getName());

    @Test(dataProvider = "clusterid-data-provider",description ="Verify that you can select a few applications, save the auto action.")
    public void validateOnlyApplication(String clusterId) {
        ...
        String policyName = "testPolicyApplicationOnly";
        ...
        test.log(LogStatus.PASS, "Validated 'only' application, selected as scope on New Auto Action Policy page");
