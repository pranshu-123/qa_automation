...
@Marker.Alerts
@Marker.All
public class TC_AA122 extends BaseClass {
    ...
    public void validateExceptApplication(String clusterId) {
        ...
        String policyName = "testPolicyApplicationExcept";
        ...
        test.log(LogStatus.PASS, "Validated 'except' application, selected as scope on New Auto Action Policy page");
