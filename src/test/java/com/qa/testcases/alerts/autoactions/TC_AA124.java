...
public class TC_AA124 extends BaseClass {
    ...
    @Test(dataProvider = "clusterid-data-provider",description="P1-Verify that the user can select a specific TIME interval daily to trigger auto actions when violations occur between that time interval.")
