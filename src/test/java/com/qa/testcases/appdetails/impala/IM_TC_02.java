...
public class IM_TC_02 extends BaseClass {
    ...
    private LoggingUtils loggingUtils = new LoggingUtils(IM_TC_02.class);
    ...
    public void verifyImpalaAppUI(String clusterId) {
        test = extent.startTest("IM_TC_02.verifyImpalaAppUI", "Verify that all KPIs are displayed in Unravel UI for " +
            "impala");
        ...
        try {
            ...
            Assert.assertNotEquals(appDetailsPage.getApplicationType(),
                AppDetailsApplicationType.IMPALA.toString().toUpperCase(), "Validate whether valid application type " +
                    "is displayed.");
