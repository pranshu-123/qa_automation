...
@Marker.All
public class TC_LLAP_17 extends BaseClass {

    private static final java.util.logging.Logger LOGGER = Logger.getLogger(TC_LLAP_17.class.getName());

    @Test(dataProvider = "clusterid-data-provider")
    public void TC_LLAP_17_verifyApplicationID(String clusterId) {
        test = extent.startTest("TC_LLAP_17_verifyApplicationID: " + clusterId,
                "Verify the \"Application ID\" of the Hive application");
        test.assignCategory(" Apps Details-TezLlap");
        Log.startTestCase("TC_LLAP_17_verifyApplicationID");
        ...
        Assert.assertEquals(appCount, totalCount, "The  Hive tez llap app count of tezApp is not equal to " +
                "the total count of heading.");
        test.log(LogStatus.PASS, "The left pane has Hive tez llap check box and the app counts match to that " +
        ...
        if (appCount > 0) {
            ...
            test.log(LogStatus.PASS, "Tez llap App name is displayed in the Table: " + Appname);
