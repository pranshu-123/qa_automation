...
public class TC_DBX_DT_18 extends BaseClass {
    ...
    @Test(dataProvider = "clusterid-data-provider",description = "Validate whether user is able to filter data with Owner column value.")
    public void verifyTableDataFilterByOwnerColumn(String clusterId) throws InterruptedException {
