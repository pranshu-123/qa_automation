...
public class TC_DBX_DT_53 extends BaseClass {
    ...
    public void validateParentAppColumnApplicationsTable(String clusterId) throws InterruptedException {
        test = extent.startTest("TC_DBX_DT_53.validateParentAppColumnApplicationsTable", "Validate the Parent App column of the table detail.");
        ...
        try {
            ...
            String applicationClusterId = dataPageObject.applicationClusterId.getText();
            loggingUtils.pass("Correct clusterId are displayed" + applicationClusterId, test);
            String applicationDetailsHeading = dataPageObject.applicationDetailsHeading.getText();
            loggingUtils.pass("Correct applicationId are displayed" + applicationDetailsHeading, test);
            Assert.assertTrue(applicationClusterId.contains(expectedClusterId) && applicationDetailsHeading.contains(expectedApplicationId), "Incorrect applicationId or clusterId are" + "displayed");
