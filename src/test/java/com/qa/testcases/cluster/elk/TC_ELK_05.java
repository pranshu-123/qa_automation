...
public class TC_ELK_05 extends BaseClass {
  ...
  public void verifyEventsEmittedKPI(String clusterId) {
    ...
    waitExecuter.waitUntilPageFullyLoaded();
    elkPage.verifyLogstashKPIs(elkPageObj, "Events Emitted");

    test.log(LogStatus.PASS, "Verified Events Emitted KPI in UI successfully ");
  }
}
