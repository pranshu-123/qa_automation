...
public class IM_RES_07  extends BaseClass {
    ...
    public void verifyClusterShouldHaveFiveNode(String clusterId) {
        test = extent.startTest("IM_RES_07.verifyClusterShouldHaveFiveNode", "Verify the tool tip of the graph should display the Total Memory and Allocated Memory of all the Nodes.)");
