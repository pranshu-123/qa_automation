...
public class TC_CJ_07 extends BaseClass {
    ...
    public void TC_CJ_07_VerifyJobsApplicationtypeinGroupBycombinations(String clusterId) {
        ...
        List<String> jobsTooltipValues = graphUtils.getjobsTooltipValues();

        for (int i = 0; i < jobsTooltipValues.size(); i++) {
            Assert.assertNotNull(jobsTooltipValues.get(i), "Tooltip value displayed null value for Job graph");
            Assert.assertNotEquals(jobsTooltipValues.get(i), "",
