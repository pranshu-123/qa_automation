...
@Marker.All
public class TC_KAFKA_17 extends BaseClass {

  private static final Logger LOGGER = Logger.getLogger(com.qa.testcases.cluster.kafka.TC_KAFKA_17.class.getName());

  @Test(dataProvider = "clusterid-data-provider")
  public void TC_KAFKA_17_verifyBytesOutperSecond(String clusterId) {
    test = extent.startTest("TC_KAFKA_17_verifyBytesOutperSecond: " + clusterId,
        "Verify 'Bytes Out per Second' KPI information name ,values and graphs");
    test.assignCategory("Kafka External");
    Log.startTestCase("TC_KAFKA_17_verifyBytesOutperSecond");
    ...
    kafkaPage.verifyKafkaClusterKPIs(kafkaPageObject, "Bytes Out per Second");
