...
public class TC_KAFKA_21 extends BaseClass {

  private static final Logger LOGGER = Logger.getLogger(com.qa.testcases.cluster.kafka.TC_KAFKA_21.class.getName());

  @Test(dataProvider = "clusterid-data-provider")
  public void TC_KAFKA_21_verifyMessagesInPerSecond(String clusterId) {
    test = extent.startTest("TC_KAFKA_21_verifyMessagesInPerSecond: " + clusterId,
        "Verify 'Messages In per Second' KPI information name ,values and graphs");
    test.assignCategory("Kafka External");
    Log.startTestCase("TC_KAFKA_21_verifyMessagesInPerSecond");
    ...
    kafkaPage.verifyKafkaKPIGraphs(kafkaPageObject, "Messages In per Second");
