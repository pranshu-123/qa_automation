...
@Marker.All
public class TC_KAFKA_29 extends BaseClass {

  private static final Logger LOGGER = Logger.getLogger(com.qa.testcases.cluster.kafka.TC_KAFKA_29.class.getName());

  @Test(dataProvider = "clusterid-data-provider")
  public void TC_KAFKA_29_verifyFetchTotalTime(String clusterId) {
    test = extent.startTest("TC_KAFKA_29_verifyFetchTotalTime: " + clusterId,
        "Verify 'Fetch Total Time, 99th Percentile' KPI information name ,values and graphs");
    test.assignCategory("Kafka External");
    Log.startTestCase("TC_KAFKA_29_verifyFetchTotalTime");
