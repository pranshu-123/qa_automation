...
@Marker.All
public class TC_KAFKA_32 extends BaseClass {

  private static final Logger LOGGER = Logger.getLogger(com.qa.testcases.cluster.kafka.TC_KAFKA_32.class.getName());

  @Test(dataProvider = "clusterid-data-provider")
  public void TC_KAFKA_32_verifyProduceRequestsperSec(String clusterId) {
    test = extent.startTest("TC_KAFKA_32_verifyProduceRequestsperSec: " + clusterId,
        "Verify '# Produce Requests per Sec' KPI information name ,values and graphs");
    test.assignCategory("Kafka External");
    Log.startTestCase("TC_KAFKA_32_verifyProduceRequestsperSec");
