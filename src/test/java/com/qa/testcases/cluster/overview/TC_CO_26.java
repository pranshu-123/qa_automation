...
@Marker.All
public class TC_CO_26 extends BaseClass {

    /**
     * Verify VCores graph 'Download PNG'
     */
    ...
    public void ValidateVCoresGraphDownloadAsPNG(String clusterId) {
        ...
        test = extent.startTest("TC_CO_26.ValidateVCoresGraphDownloadAsPNG: " + clusterId,
                "Validate download of VCores graph as PNG file.");
        ...
        homePage.downloadVCoresGraphAsFile("Download PNG");
        LOGGER.info("Download PNG file");

        Assert.assertTrue(FileUtils.checkForFileNameInDownloadsFolder("VCores.png"), "File is not downloaded " +
                "or size of file is zero bytes.");
        test.log(LogStatus.PASS, "Successfully downloaded VCores graph as PNG file.");
        LOGGER.info("Successfully downloaded VCores graph as PNG file.");
    }
