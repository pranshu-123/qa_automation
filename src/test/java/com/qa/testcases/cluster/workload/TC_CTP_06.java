...
public class TC_CTP_06 extends BaseClass {
    ...
    public void VerifyallviewbyfiltersinByMemoryHourspage(String clusterId) {
        test = extent.startTest("TC_CTP_06.VerifyallviewbyfiltersinByMemoryHourspage", "Verify Cluster workload report should be generated as per selected view by filter");
