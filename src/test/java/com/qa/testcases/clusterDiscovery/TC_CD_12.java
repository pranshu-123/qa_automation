...
public class TC_CD_12 extends BaseClass {
    private static final Logger LOGGER = Logger.getLogger(TC_CD_12.class.getName());

    @Test
    public void validateHeatMapForCPU() {
        test = extent.startTest("TC_CD_12.validateHeatMapForCPU",
                "Verify that Unravel UI should generate a Cluster Discovery heat map for cpu.");
