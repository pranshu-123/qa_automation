...
@Marker.All
public class TC_CF_11 extends BaseClass {
    private static final Logger LOGGER = Logger.getLogger(TC_CF_11.class.getName());

    @Test(dataProvider = "clusterid-data-provider")
    public void validateScheduleCapacityForecastingReports(String clusterId) {
        test = extent.startTest("TC_CF_11.validateScheduleCapacityForecastingReports: " + clusterId,
                "Verify User is able to generate schedule capacity forecasting report.");
