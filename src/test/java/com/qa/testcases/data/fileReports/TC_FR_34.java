...
public class TC_FR_34 extends BaseClass {
     ...
     */
    @Test(dataProvider = "clusterid-data-provider",description = "P1-Validate that the user is able to sort based on Max File Size column for Medium file reports")
    public void validateMaxFileSizeSortForMediumFiles(String clusterId) {
        test = extent.startTest("TC_FR_34.validateMaxFileSizeSortForMediumFiles " + clusterId,
                "P1-Validate that the user is able to sort based on Max File Size column for Medium file reports");
