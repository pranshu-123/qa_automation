...
@Marker.All
public class TC_SF_19 extends BaseClass {

    Logger logger = Logger.getLogger(TC_SF_19.class.getName());

    @Test(dataProvider = "clusterid-data-provider")
    public void verifySpecialCharacters(String clusterId) {
        test = extent.startTest("TC_SF_19.verifySpecialCharacters: " + clusterId,
                "Verify User generate small file report for file names that have special characters.");
        test.assignCategory("Data- Small Files");
        Log.startTestCase("TC_SF_19.verifySpecialCharacters");
