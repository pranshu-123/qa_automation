...
public class TC_CMP_04 extends BaseClass{
	...
	private static final Logger LOGGER = Logger.getLogger(TC_CMP_04.class.getName());

	@Test
	public void TC_Compute_04_verifyRunningJobStatus() {
		test = extent.startTest("TC_Compute_04_verifyRunningJobStatus", "Verify All the running jobs are listed on the page");
		test.assignCategory("Compute");
		Log.startTestCase("TC_Compute_04_verifyRunningJobStatus");
