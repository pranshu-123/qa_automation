...
public class TC_CMP_21 extends BaseClass{
	...
	private static final Logger LOGGER = Logger.getLogger(TC_CMP_21.class.getName());

	@Test
	public void TC_Compute_21_verifyClusterSearchWithInValidParams() {
		test = extent.startTest("TC_Compute_19_verifyUserSearchWithInValidParams", "Verify Cluster Type filter search functionality with invalid parameters");
		...
		String errMsg =	compute.invalidSearchParametersValidation("Cluster");
