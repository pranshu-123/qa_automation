...
public class TC_CMP_30 extends BaseClass{
	...
	private static final Logger LOGGER = Logger.getLogger(TC_CMP_30.class.getName());

	@Test
	public void TC_Compute_30_validateComputeAsPerCustomDate() {
		test = extent.startTest("TC_Compute_30_validateComputeAsPerCustomDate", "Verify Custom Range in datepicker");
		test.assignCategory("Compute");
		Log.startTestCase("TC_Compute_30_validateComputeAsPerCustomDate");
