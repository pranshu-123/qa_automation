...
@Marker.DbxCompute
public class TC_CMP_34 extends BaseClass{

	private static final Logger LOGGER = Logger.getLogger(TC_CMP_34.class.getName());

	@Test
	public void TC_Compute_34_verifySortingAsPerClusterType() {
		test = extent.startTest("TC_Compute_34_verifySortingAsPerClusterType", "Sort jobs as per Cluster Type");
		test.assignCategory("Compute");
		Log.startTestCase("TC_Compute_34_verifySortingAsPerClusterType");
		...
		compute.validateSorting("Cluster Type");
