...
@Marker.DbxCompute
public class TC_CMP_42 extends BaseClass{

	private static final Logger LOGGER = Logger.getLogger(TC_CMP_42.class.getName());

	@Test
	public void TC_Compute_42_verifySparkDetailsForSuccessfulJobs() {
		test = extent.startTest("TC_Compute_42_verifySparkDetailsForSuccessfulJobs", "Verify Spark Details tabs for successful job");
		test.assignCategory("Compute");
		Log.startTestCase("TC_Compute_42_verifySparkDetailsForSuccessfulJobs");
