...
@Marker.DbxJobs
@Marker.All
public class TC_DJ_07 extends BaseClass {
    private final LoggingUtils loggingUtils = new LoggingUtils(TC_DJ_07.class);

    @Test()
    public void validateWorkSpace() {
        test = extent.startTest("TC_DJ_07.validateWorkSpace",
                "Verify WorkSpace Name are listed on the application page");
