...
@Marker.DbxJobs
@Marker.All
public class TC_DJ_08 extends BaseClass {
    private final LoggingUtils loggingUtils = new LoggingUtils(TC_DJ_08.class);
    ...
    public void validateUser() {
        ...
        try {
            ...
            String headerAppId = jobsPage.verifyUser(jobsPageObject);
            test.log(LogStatus.PASS, "Application User Name is displayed: " + headerAppId);
