...
@Marker.DbxRuns
@Marker.All
public class TC_DR_41 extends BaseClass {
    private final LoggingUtils loggingUtils = new LoggingUtils(TC_DR_41.class);

    @Test()
    public void validateKilledStatusInFinishedTab() {
        test = extent.startTest("TC_DR_41.validateKilledStatusInFinishedTab",
