...
public class TC_DR_42 extends BaseClass {
    private final LoggingUtils loggingUtils = new LoggingUtils(TC_DR_42.class);

    @Test()
    public void validateFailedStatusInFinishedTab() {
        test = extent.startTest("TC_DR_42.validateFailedStatusInFinishedTab",
