...
public class TC_DR_51 extends BaseClass {
    private final LoggingUtils loggingUtils = new LoggingUtils(TC_DR_51.class);

    @Test()
    public void validateGlobalSearchInFinishedTab() {
        test = extent.startTest("TC_DR_51.validateGlobalSearchInFinishedTab",
