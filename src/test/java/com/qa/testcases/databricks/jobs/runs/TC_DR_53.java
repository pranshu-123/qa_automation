...
@Marker.DbxRuns
@Marker.All
public class TC_DR_53 extends BaseClass {
    private final LoggingUtils loggingUtils = new LoggingUtils(TC_DR_53.class);

    @Test()
    public void validateDatePickerFiltersInFinishedTab() {
        test = extent.startTest("TC_DR_53.validateDatePickerFiltersInFinishedTab",
