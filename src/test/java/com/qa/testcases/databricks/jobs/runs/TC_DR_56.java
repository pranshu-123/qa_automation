...
@Marker.DbxRuns
@Marker.All
public class TC_DR_56 extends BaseClass {
    private final LoggingUtils loggingUtils = new LoggingUtils(TC_DR_56.class);

    @Test()
    public void searchJobsByWorkspaceInFinishedTab() {
        test = extent.startTest("TC_DR_56.searchJobsByWorkspaceInFinishedTab",
                "Verify search must populate desired job by Workspace");
        ...
        try {
            ...
            String applicationTypeToSearch = dbpageObject.getWorkspaceFromTable.getText();
            ...
            test.log(LogStatus.INFO, "Get Workspace of first application listed in table and search ");
            dbpageObject.searchBox.clear();
