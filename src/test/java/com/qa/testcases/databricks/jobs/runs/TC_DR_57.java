...
@Marker.DbxRuns
@Marker.All
public class TC_DR_57 extends BaseClass {
    private final LoggingUtils loggingUtils = new LoggingUtils(TC_DR_57.class);

    @Test()
    public void searchJobsByClusterNameInFinishedTab() {
        test = extent.startTest("TC_DR_57.searchJobsByClusterNameInFinishedTab",
