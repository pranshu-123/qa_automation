...
@Marker.DbxRuns
@Marker.All
public class TC_DR_62 extends BaseClass {
    private final LoggingUtils loggingUtils = new LoggingUtils(TC_DR_62.class);

    @Test()
    public void VerifyUserSearchInRunningTab() {
        test = extent.startTest("TC_DR_62.VerifyUserSearchInRunningTab ",
