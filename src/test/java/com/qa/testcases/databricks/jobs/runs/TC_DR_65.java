...
@Marker.DbxRuns
@Marker.All
public class TC_DR_65 extends BaseClass {
    private final LoggingUtils loggingUtils = new LoggingUtils(TC_DR_65.class);

    @Test()
    public void validateResetFunctionalityInRunningTab() {
        test = extent.startTest("TC_DR_65.validateResetFunctionalityInRunningTab",
