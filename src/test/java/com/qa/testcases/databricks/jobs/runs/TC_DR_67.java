...
@Marker.DbxRuns
@Marker.All
public class TC_DR_67 extends BaseClass {
    private final LoggingUtils loggingUtils = new LoggingUtils(TC_DR_67.class);

    @Test()
    public void validateGlobalSearchInRunningTab() {
        test = extent.startTest("TC_DR_67.validateGlobalSearchInRunningTab",
