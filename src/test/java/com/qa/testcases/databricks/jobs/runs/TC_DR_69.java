...
public class TC_DR_69 extends BaseClass {
    private final LoggingUtils loggingUtils = new LoggingUtils(TC_DR_69.class);

    @Test()
    public void validateDatePickerFiltersInRunningTab() {
        test = extent.startTest("TC_DR_69.validateDatePickerFiltersInRunningTab",
