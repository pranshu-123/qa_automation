...
@Marker.DbxRuns
@Marker.All
public class TC_DR_70 extends BaseClass {
    private final LoggingUtils loggingUtils = new LoggingUtils(TC_DR_70.class);

    @Test()
    public void SearchJobsByNameInRunningTab() {
        test = extent.startTest("TC_DR_70.SearchJobsByNameInRunningTab",
