...
@Marker.DbxRuns
@Marker.All
public class TC_DR_72 extends BaseClass {
    private final LoggingUtils loggingUtils = new LoggingUtils(TC_DR_72.class);

    @Test()
    public void searchJobsByWorkspaceInRunningTab() {
        test = extent.startTest("TC_DR_72.searchJobsByWorkspaceInRunningTab",
