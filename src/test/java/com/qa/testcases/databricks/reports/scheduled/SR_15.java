...
public class SR_15 extends BaseClass

{
	private static final Logger LOGGER = Logger.getLogger(SR_15.class.getName());
	@Test
	public void SH_Reports_15_ValidateNotification() {
		test = extent.startTest("SH_Reports_15_ValidateNotification", "Validate Notification option while scheduling report");
		test.assignCategory("Reports/Scheduled");
		Log.startTestCase("SH_Reports_15_ValidateNotification");
		...
		scheduledReports.addEmailNotification("pagarwal@unraveldata.com",false);
