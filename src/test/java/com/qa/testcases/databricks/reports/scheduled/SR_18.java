...
public class SR_18 extends BaseClass

{
	private static final Logger LOGGER = Logger.getLogger(SR_18.class.getName());
	@Test
	public void SH_Reports_18_ScheduleMonthlyReportFromArchivedPage() {
		test = extent.startTest("SH_Reports_18_ScheduleMonthlyReportFromArchivedPage", "Schedule a monthly report from Archived page");
		test.assignCategory("Reports/Scheduled");
		Log.startTestCase("SH_Reports_18_ScheduleMonthlyReportFromArchivedPage");
		...
		scheduledReports.selectScheduledTime("Every Month");
