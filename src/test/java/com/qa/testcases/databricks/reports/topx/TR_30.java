...
public class TR_30 extends BaseClass

{
	private static final Logger LOGGER = Logger.getLogger(TR_30.class.getName());
	@Test
	public void TopX_Reports_30_downloadHighestClusterReport() {
		test = extent.startTest("TopX_Reports_30_downloadHighestClusterReport", "Download Highest Cluster Usage report");
		test.assignCategory("Reports/TopX");
		Log.startTestCase("TopX_Reports_30_downloadHighestClusterReport");
