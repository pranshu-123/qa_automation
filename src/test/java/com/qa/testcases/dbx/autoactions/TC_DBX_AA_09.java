...
public class TC_DBX_AA_09 extends BaseClass {
	private static final java.util.logging.Logger logger = Logger.getLogger(TC_DBX_AA_09.class.getName());
	...
	public void TC_DBX_AA_09_validateDescriptionNameAsSpecialChars() {
		...
		dbxAutoAction.enterNewAutoActionPolicyDetails(policyName, "3",policyDescription);
		...
		Assert.assertTrue(aa.validateAutoActionAdded(policyName), "Newly added Policy name and desc : " +
