...
public class TC_DBX_AA_11 extends BaseClass {
	private static final java.util.logging.Logger logger = Logger.getLogger(TC_DBX_AA_11.class.getName());

	@Test
	public void TC_DBX_AA_11_validateAllUserAutoAction() {
		test = extent.startTest("TC_DBX_AA_11_validateAllUserAutoAction", "Verify user is able to select ALL as user, save the auto action.");
		test.assignCategory(" Alerts ");
		Log.startTestCase("TC_DBX_AA_11_validateAllUserAutoAction");
		...
		dbxAutoAction.selectScopeType("User","all");
