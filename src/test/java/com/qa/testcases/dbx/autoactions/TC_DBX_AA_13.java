...
public class TC_DBX_AA_13 extends BaseClass {
	private static final java.util.logging.Logger logger = Logger.getLogger(TC_DBX_AA_13.class.getName());

	@Test
	public void TC_DBX_AA_13_validateExceptUserAutoAction() {
		test = extent.startTest("TC_DBX_AA_13_validateExceptUserAutoAction", "Verify user is able to select except particular users, save the auto action.");
		test.assignCategory(" Alerts ");
		Log.startTestCase("TC_DBX_AA_13_validateExceptUserAutoAction");
		...
		dbxAutoAction.selectScopeType("User","except");
