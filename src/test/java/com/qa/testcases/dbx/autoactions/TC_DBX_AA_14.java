...
public class TC_DBX_AA_14 extends BaseClass {
	private static final java.util.logging.Logger logger = Logger.getLogger(TC_DBX_AA_14.class.getName());

	@Test
	public void TC_DBX_AA_14_validateAllQueueAutoAction() {
		test = extent.startTest("TC_DBX_AA_14_validateAllQueueAutoAction", "Verify user is able to select all queue's, save the auto action.");
		test.assignCategory(" Alerts ");
		Log.startTestCase("TC_DBX_AA_14_validateAllQueueAutoAction");
		...
		dbxAutoAction.selectScopeType("Queue","all");
