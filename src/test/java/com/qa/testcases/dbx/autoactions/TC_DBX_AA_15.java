...
public class TC_DBX_AA_15 extends BaseClass {
	private static final java.util.logging.Logger logger = Logger.getLogger(TC_DBX_AA_15.class.getName());

	@Test
	public void TC_DBX_AA_15_validateOnlyFewQueueAutoAction() {
		test = extent.startTest("TC_DBX_AA_15_validateOnlyFewQueueAutoAction", "\"Verify user is able to select only a few queues, save the auto action.");
		test.assignCategory(" Alerts ");
		Log.startTestCase("TC_DBX_AA_15_validateOnlyFewQueueAutoAction");
