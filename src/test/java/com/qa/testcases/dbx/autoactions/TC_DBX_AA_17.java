...
public class TC_DBX_AA_17 extends BaseClass {
	private static final java.util.logging.Logger logger = Logger.getLogger(TC_DBX_AA_17.class.getName());

	@Test
	public void TC_DBX_AA_17_validateAllClusterAutoActionJob() {
		test = extent.startTest("TC_DBX_AA_17_validateAllClusterAutoActionJob", "Verify user is able to select all clusters, save the auto action.");
		test.assignCategory(" Alerts ");
		Log.startTestCase("TC_DBX_AA_17_validateAllClusterAutoActionJob");
		...
		dbxAutoAction.selectScopeType("Cluster","all");
