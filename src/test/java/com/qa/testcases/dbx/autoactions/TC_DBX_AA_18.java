...
public class TC_DBX_AA_18 extends BaseClass {
	private static final java.util.logging.Logger logger = Logger.getLogger(TC_DBX_AA_18.class.getName());

	@Test
	public void TC_DBX_AA_18_validateOnlyFewClusterAutoActionJob() {
		test = extent.startTest("TC_DBX_AA_18_validateOnlyFewClusterAutoActionJob", "Verify user is able to select only a few cluster, save the auto action.");
		test.assignCategory(" Alerts ");
		Log.startTestCase("TC_DBX_AA_18_validateOnlyFewClusterAutoActionJob");
		...
		dbxAutoAction.selectScopeType("Cluster","only");
