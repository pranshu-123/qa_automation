...
public class TC_DBX_AA_20 extends BaseClass {
	private static final java.util.logging.Logger logger = Logger.getLogger(TC_DBX_AA_20.class.getName());

	@Test
	public void TC_DBX_AA_20_validateAllJobRunAutoActionJob() {
		test = extent.startTest("TC_DBX_AA_20_validateAllJobRunAutoActionJob", "Verify user is able to select all job rub, save the auto action.");
		test.assignCategory(" Alerts ");
		Log.startTestCase("TC_DBX_AA_20_validateAllJobRunAutoActionJob");
		...
		dbxAutoAction.selectScopeType("Job Run","all");
