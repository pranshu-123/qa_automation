...
public class TC_DBX_AA_21 extends BaseClass {
	private static final java.util.logging.Logger logger = Logger.getLogger(TC_DBX_AA_21.class.getName());

	@Test
	public void TC_DBX_AA_21_validateOnlyFewJobRunAutoAction() {
		test = extent.startTest("TC_DBX_AA_21_validateOnlyFewJobRunAutoAction", "Verify user is able to select a few job run, save the auto action.");
		test.assignCategory(" Alerts ");
		Log.startTestCase("TC_DBX_AA_21_validateOnlyFewJobRunAutoAction");
