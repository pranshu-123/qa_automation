...
public class TC_DBX_AA_22 extends BaseClass {
	private static final java.util.logging.Logger logger = Logger.getLogger(TC_DBX_AA_22.class.getName());

	@Test
	public void TC_DBX_AA_22_validateExceptFewJobRunAutoAction() {
		test = extent.startTest("TC_DBX_AA_22_validateExceptFewJobRunAutoAction", "Verify user is able to select except few job run, save the auto action.");
		test.assignCategory(" Alerts ");
		Log.startTestCase("TC_DBX_AA_22_validateExceptFewJobRunAutoAction");
		...
		dbxAutoAction.selectRefinedScope("Job Run");
		dbxAutoAction.selectScopeType("Job Run","only");
