...
public class TC_DBX_AA_23 extends BaseClass {
	private static final java.util.logging.Logger logger = Logger.getLogger(TC_DBX_AA_23.class.getName());

	@Test
	public void TC_DBX_AA_23_TimeAsAlwaysInScope() {
		test = extent.startTest("TC_DBX_AA_23_TimeAsAlwaysInScope", "Verify user is able to select TIME scope as ALWAYS and save auto action.");
		test.assignCategory(" Alerts ");
		Log.startTestCase("TC_DBX_AA_23_TimeAsAlwaysInScope");
		...
		dbxAutoAction.selectScopeType("Time","always");
		...
		test.log(LogStatus.PASS, "AA created with Time as Always within Refined Scoped");
	}
}
