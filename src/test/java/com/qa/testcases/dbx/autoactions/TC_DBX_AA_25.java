...
public class TC_DBX_AA_25 extends BaseClass {
	private static final java.util.logging.Logger logger = Logger.getLogger(TC_DBX_AA_25.class.getName());

	@Test
	public void TC_DBX_AA_25_CreateAutoActionWithNoActions() {
		test = extent.startTest("TC_DBX_AA_25_CreateAutoActionWithNoActions", "Select no auto action, save and verify the behaviour of the auto action.");
		test.assignCategory(" Alerts ");
		Log.startTestCase("TC_DBX_AA_25_CreateAutoActionWithNoActions");
