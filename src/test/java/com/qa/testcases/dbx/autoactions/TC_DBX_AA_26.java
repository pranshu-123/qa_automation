...
public class TC_DBX_AA_26 extends BaseClass {
	private static final java.util.logging.Logger logger = Logger.getLogger(TC_DBX_AA_26.class.getName());

	@Test
	public void TC_DBX_AA_26_validateSendEmailFunctionality() {
		test = extent.startTest("TC_DBX_AA_26_validateSendEmailFunctionality", "Select one auto action (send email) and verify the behaviour when no recipient is selected.");
		test.assignCategory(" Alerts ");
		Log.startTestCase("TC_DBX_AA_26_validateSendEmailFunctionality");
		...
		test.log(LogStatus.PASS, "Email send functionality validated");
	}
}
