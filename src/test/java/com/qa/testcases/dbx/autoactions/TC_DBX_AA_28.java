...
public class TC_DBX_AA_28 extends BaseClass {
	private static final java.util.logging.Logger logger = Logger.getLogger(TC_DBX_AA_28.class.getName());

	@Test
	public void TC_DBX_AA_28_HttpActionWithoutUrl() {
		test = extent.startTest("TC_DBX_AA_28_HttpActionWithoutUrl", "Validate the behaviour - select HTTP Post action and save AA withoud adding URL");
		test.assignCategory(" Alerts ");
		Log.startTestCase("TC_DBX_AA_28_HttpActionWithoutUrl");
