...
public class TC_DBX_AA_36 extends BaseClass {
	private static final java.util.logging.Logger logger = Logger.getLogger(TC_DBX_AA_36.class.getName());

	@Test
	public void TC_DBX_AA_36_createAllPurposeJobWithDurationAsTriggerCondition() {
		test = extent.startTest("TC_DBX_AA_35_createAllPurposeJobWithCostAsTriggerCondition", "Create AA job for All purpose Databricks Cluster with cost as trigger condition");
		...
		dbxAutoAction.setTotalDurationValue(metric, value);
		...
		test.log(LogStatus.PASS, "All Purpose Job with Trigger condition as Cost worked as expected");
	}
}
