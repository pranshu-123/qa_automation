...
public class TC_DBX_AA_39 extends BaseClass {
	private static final java.util.logging.Logger logger = Logger.getLogger(TC_DBX_AA_39.class.getName());

	@Test
	public void TC_DBX_AA_39_validate2RuleSetWithSameOperator() {
		test = extent.startTest("TC_DBX_AA_39_validate2RuleSetWithSameOperator", "Verify that each function of AA by adding more than 2 RULE SET - SAME");
		test.assignCategory(" Alerts ");
		Log.startTestCase("TC_DBX_AA_39_validate2RuleSetWithSameOperator");
		DbxAutoAction dbxAutoAction = new DbxAutoAction(driver);
		WaitExecuter waitExecuter = new WaitExecuter(driver);
		String condition = "SAME";
		...
		test.log(LogStatus.PASS, "Two Rule Set validated with SAME Operator");
	}
}
