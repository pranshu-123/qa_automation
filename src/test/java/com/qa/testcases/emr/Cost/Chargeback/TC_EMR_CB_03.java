...
public class TC_EMR_CB_03 extends BaseClass {

    private static final Logger LOGGER = Logger.getLogger(DC_02.class.getName());

    @Test
    public void TC_EMR_CB_03_VerifyGraphs() {
        test = extent.startTest("TC_EMR_CB_03_VerifyGraphs", "Graphs are properly displayed");
        test.assignCategory("Cost/Chargeback");
        Log.startTestCase("TC_EMR_CB_03_VerifyGraphs");
