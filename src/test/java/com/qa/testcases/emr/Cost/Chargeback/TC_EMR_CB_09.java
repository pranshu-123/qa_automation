...
public class TC_EMR_CB_09 extends BaseClass {

    private static final Logger LOGGER = Logger.getLogger(TC_EMR_CB_09.class.getName());

    @Test
    public void TC_EMR_CB_09_SelectPurposeTags() {
        test = extent.startTest("TC_EMR_CB_09_SelectPurposeTags", "Validation of Purpose Tags");
        test.assignCategory("Cost/Chargeback");
        Log.startTestCase("TC_EMR_CB_09_SelectPurposeTags");
        ...
        LOGGER.info("Clicking on Purpose option.");
        waitExecuter.sleep(2000);
        try {chargeBack.PurposeSelect();}
        catch (Exception e){}
