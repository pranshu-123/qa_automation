...
public class TC_EMR_CB_12 extends BaseClass {
    ...
    private static final Logger LOGGER = Logger.getLogger(TC_EMR_CB_12.class.getName());

    @Test
    public void TC_EMR_CB_12_VerifyTenureinCBbyTagKey() throws InterruptedException {
        test = extent.startTest("TC_EMR_CB_12_VerifyTenureinCBbyTagKey", "Validation of ChargeBack by Tag key Ddn");
        test.assignCategory("Cost/Chargeback");
        Log.startTestCase("TC_EMR_CB_12_VerifyTenureinCBbyTagKey");
        ...
        test.log(LogStatus.PASS, "Validated the result corresponding to Tenure in Chargeback by Tag key");
