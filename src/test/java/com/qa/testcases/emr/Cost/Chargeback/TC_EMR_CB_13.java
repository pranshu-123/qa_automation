...
public class TC_EMR_CB_13 extends BaseClass {

    private static final Logger LOGGER = Logger.getLogger(TC_EMR_CB_13.class.getName());

    @Test
    public void TC_EMR_CB_13_VerifyPurposeinCBbyTagKey() throws InterruptedException {
        test = extent.startTest("TC_EMR_CB_13_VerifyPurposeinCBbyTagKey", "Validation of purpose in CB key");
        test.assignCategory("Cost/Chargeback");
        Log.startTestCase("TC_EMR_CB_13_VerifyPurposeinCBbyTagKey");
        ...
        LOGGER.info("User is able to select Purpose in Chargeback by tag key");
        chargeBack.ValidatePieChartGraph(expectedGraphValues);
        chargeBack.ValidateResultSetIsDisplayedWithValues();
        test.log(LogStatus.PASS, "Validated the result corresponding to Purpose in Chargeback by Tag key ");
