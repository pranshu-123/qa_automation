...
public class TC_EMR_CB_16 extends BaseClass {

    private static final Logger LOGGER = Logger.getLogger(TC_EMR_CB_16.class.getName());

    @Test
    public void TC_EMR_CB_16_VerifyClustersforTenure() throws InterruptedException {
        test = extent.startTest("TC_EMR_CB_16_VerifyClustersforTenure", "Validation of Clusters for Tenure");
        test.assignCategory("Cost/Chargeback");
        Log.startTestCase("TC_EMR_CB_16_VerifyClustersforTenure");
        ...
        test.log(LogStatus.PASS, "Validated View Clusters page Graphs corresponding to Tenure");
        LOGGER.info("Validated View Clusters page Graphs corresponding to Tenure");
