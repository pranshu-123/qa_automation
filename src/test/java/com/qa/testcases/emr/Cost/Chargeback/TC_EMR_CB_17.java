...
public class TC_EMR_CB_17 extends BaseClass {

    private static final Logger LOGGER = Logger.getLogger(TC_EMR_CB_17.class.getName());

    @Test
    public void TC_EMR_CB_17_VerifyTrendsforPurpose() throws InterruptedException {
        test = extent.startTest("TC_EMR_CB_17_VerifyTrendsforPurpose", "Validation of Trends for Purpose");
        test.assignCategory("Cost/Chargeback");
        Log.startTestCase("TC_EMR_CB_17_VerifyTrendsforPurpose");
        ...
        test.log(LogStatus.PASS, "Validated View Trends page Graphs corresponding to Purpose");
        LOGGER.info("Validated View Trends page Graphs corresponding to Purpose");
