...
public class TC_EMR_CB_19 extends BaseClass {

    private static final Logger LOGGER = Logger.getLogger(TC_EMR_CB_19.class.getName());

    @Test
    public void TC_EMR_CB_19_VerifyTrendsforName() throws InterruptedException {
        test = extent.startTest("TC_EMR_CB_19_VerifyTrendsforName", "Validation of Trends for Name");
        test.assignCategory("Cost/Chargeback");
        Log.startTestCase("TC_EMR_CB_19_VerifyTrendsforName");
        ...
        test.log(LogStatus.PASS, "Validated View Trends page Graphs corresponding to Name");
        LOGGER.info("Validated View Trends page Graphs corresponding to Name");
