...
public class TC_EMR_CB_20 extends BaseClass {

    private static final Logger LOGGER = Logger.getLogger(TC_EMR_CB_20.class.getName());

    @Test
    public void TC_EMR_CB_20_VerifyClustersforName() throws InterruptedException {
        test = extent.startTest("TC_EMR_CB_20_VerifyClustersforName", "Validation of Cluster for Name");
        test.assignCategory("Cost/Chargeback");
        Log.startTestCase("TC_EMR_CB_20_VerifyClustersforName");
        ...
        test.log(LogStatus.PASS, "Validated View Clusters page Graphs corresponding to Name");
        LOGGER.info("Validated View Clusters page Graphs corresponding to Name");
