...
public class TC_EMR_CB_22 extends BaseClass {

    private static final Logger LOGGER = Logger.getLogger(TC_EMR_CB_22.class.getName());

    @Test
    public void TC_EMR_CB_22_VerifyBudgetforPurpose() throws InterruptedException {
        test = extent.startTest("TC_EMR_CB_22_VerifyBudgetforPurpose", "Validation of Budget for Purpose");
        test.assignCategory("Cost/Chargeback");
        Log.startTestCase("TC_EMR_CB_22_VerifyBudgetforPurpose");
        ...
        test.log(LogStatus.PASS, "Validated Create Budget page corresponding to Purpose");
        LOGGER.info("Validated Create Budget page corresponding to Purpose");
