...
@Marker.EMRSpark
public class TC_EMR_SPARK_04 extends BaseClass {
    private final LoggingUtils logger = new LoggingUtils(TC_EMR_SPARK_04.class);

    @Test()
    public void validateLoadDiagnosticAction() {
        test = extent.startTest("TC_EMR_SPARK_04.validateLoadDiagnosticAction",
        ...
        try {
            ...
            if (appCount > 0) {
                ...
                appsDetailsPage.verifyLoadDiagnosticAction(sparkPageObj);
                ...
                wait.waitUntilElementClickable(sparkPageObj.resetButton);
                sparkPageObj.resetButton.click();
                wait.waitUntilElementClickable(sparkPageObj.resetButton);
            } else {
