...
@Marker.EMRSpark
public class TC_EMR_SPARK_16 extends BaseClass {
    Logger logger = Logger.getLogger(TC_EMR_SPARK_16.class.getName());
    @Test()
    public void TC_EMR_SPARK_16_verifyTimingsTab() {
        test = extent.startTest("TC_EMR_SPARK_16_verifyTimingsTab: ",
        ...
        Log.startTestCase("TC_EMR_SPARK_16_verifyTimingsTab");
        test.log(LogStatus.INFO, "Login to the application");
        // Initialize all classes objects
        test.assignCategory(" Apps Details-Spark");
        EmrSparkAppsDetailsPage appsDetailsPage = new EmrSparkAppsDetailsPage(driver);
        appsDetailsPage.commonSetupCodeForSummarryTabValidation(test, "Timings", logger, false,false);
