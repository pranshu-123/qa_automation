...
public class TC_EMR_12 extends BaseClass {

	Logger logger = LoggerFactory.getLogger(TC_EMR_12.class);

	@Test
	public void TC_EMR_12_verifyEC2CostFromInsights() {
		test = extent.startTest("TC_EMR_12_verifyEC2CostFromInsights", "Verify the EC2 Cost displayed in the chargeback report");
