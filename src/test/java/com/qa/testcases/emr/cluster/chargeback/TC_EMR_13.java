...
public class TC_EMR_13 extends BaseClass {

	Logger logger = LoggerFactory.getLogger(TC_EMR_13.class);

	@Test
	public void TC_EMR_13_verifyEMRCostFromInsights() {
		test = extent.startTest("TC_EMR_13_verifyEMRCostFromInsights", "Verify the EMR Cost displayed in the chargeback report");
