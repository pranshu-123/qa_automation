...
public class TC_CJT_02  extends BaseClass{

	private static final Logger LOGGER = Logger.getLogger(TC_CJT_02.class.getName());

	@Test
	public void TC_CJT_02_VerifyAcceptedGraphForGroupByState() {
