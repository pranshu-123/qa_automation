...
public class TC_CJT_06  extends BaseClass{

	private static final Logger LOGGER = Logger.getLogger(TC_CJT_06.class.getName());

	@Test
	public void TC_CJT_06_VerifyMapRGraphForGroupByApplicationType() {
		test = extent.startTest("TC_CJT_06_VerifyMapRGraphForGroupByApplicationType", "Validate Graph for Group By Application Type filter");
		test.assignCategory("EMR/ClusterJobTrends");
		Log.startTestCase("TC_CJT_06_VerifyMapRGraphForGroupByApplicationType");
		ClusterJobTrends clusterJobTrends = new ClusterJobTrends(driver);
		WaitExecuter waitExecuter = new WaitExecuter(driver);
		DatePicker datePicker = new DatePicker(driver);
		String groupBy = "Application Type";
		String filterType = "MapReduce";
