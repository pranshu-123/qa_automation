...
public class TC_CJT_12  extends BaseClass{

	private static final Logger LOGGER = Logger.getLogger(TC_CJT_12.class.getName());

	@Test
	public void TC_CJT_12_verifyDownloadGraphAsPdf() {
		test = extent.startTest("TC_CJT_12_verifyDownloadGraphAsPdf", "Download Graph as PDF");
		test.assignCategory("EMR/ClusterJobTrends");
		Log.startTestCase("TC_CJT_12_verifyDownloadGraphAsPdf");
		...
		clusterJobTrends.selectDownloadOption("PDF");
		waitExecuter.sleep(2000);
