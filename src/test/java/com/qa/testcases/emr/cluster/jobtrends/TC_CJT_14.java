...
public class TC_CJT_14  extends BaseClass{

	private static final Logger LOGGER = Logger.getLogger(TC_CJT_14.class.getName());

	@Test
	public void TC_CJT_14_verifyDownloadGraphAsSvg() {
		test = extent.startTest("TC_CJT_14_verifyDownloadGraphAsSvg", "Download Graph as SVG");
		test.assignCategory("EMR/ClusterJobTrends");
		Log.startTestCase("TC_CJT_14_verifyDownloadGraphAsSvg");
		...
		clusterJobTrends.selectDownloadOption("SVG");
		waitExecuter.sleep(2000);
