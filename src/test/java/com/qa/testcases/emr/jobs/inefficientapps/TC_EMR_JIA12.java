...
public class TC_EMR_JIA12 extends BaseClass {

    private final LoggingUtils LOGGER = new LoggingUtils(TC_EMR_JIA12.class);

    /**
     * Verify Hive Kpis
     */
    @Test()
    public void ValidateHiveKpis() {
        test = extent.startTest("TC_EMR_JIA12.ValidateHiveKpis", "All the KPIs should be listed and the data must be populated");
        ...
        waitExecuter.waitUntilPageFullyLoaded();
        int appHiveCount = inefficientApps.clickOnlyLink("HiveExecuteParallelEvent");
        ...
        Assert.assertEquals(appHiveCount, totalCount,
                "The Spark app count of HiveApp is not equal to " + "the total count of heading.");
