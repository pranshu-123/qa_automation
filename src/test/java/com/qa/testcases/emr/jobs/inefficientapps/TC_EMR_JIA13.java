...
public class TC_EMR_JIA13 extends BaseClass {
     ...
     */
    @Test()
    public void ValidateSparkKpis() {
        test = extent.startTest("TC_EMR_JIA12.ValidateSparkKpis", "All the KPIs should be listed and the data must be populated");
        ...
        inefficientApps.clickOnlyLink("Spark");
        waitExecuter.waitUntilPageFullyLoaded();
        int appSparkCount = inefficientApps.clickOnlyLink("ContendedDriverEvent");
        ...
        Assert.assertEquals(appSparkCount, totalCount,
