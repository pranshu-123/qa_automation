...
@Marker.EmrManage
@Marker.All
public class TC_EMRM_04 extends BaseClass {
    Logger logger = LoggerFactory.getLogger(TC_EMRM_04.class);
    ...
    public void validateViewAndLogLevel() {
        test = extent.startTest("TC_EMRM_04.validateViewAndLogLevel", "Verify logs with respect to " +
