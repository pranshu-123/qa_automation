...
@Marker.EmrManage
@Marker.All
public class TC_EMRM_22 extends BaseClass {
    Logger logger = LoggerFactory.getLogger(TC_EMRM_22.class);


    @Test()
    public void validateAuditFilter() {
        test = extent.startTest("TC_EMRM_22.validateAuditTab", "Verify" +
                " Audit  page ");
