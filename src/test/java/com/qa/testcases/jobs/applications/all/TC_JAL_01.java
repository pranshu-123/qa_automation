...
public class TC_JAL_01 extends BaseClass {
    ...
    public void validateDatePickerFilters(String clusterId) {
		...
		// clicked on Jobs header
		test.log(LogStatus.INFO, "clicked on Jobs header");
		LOGGER.info("clicked on Jobs header");
        topPanelComponentPageObject.jobs.click();
        waitExecuter.sleep(3000);
		//Validate jobs page is loaded successfully
		test.log(LogStatus.INFO, "Validate jobs page is loaded successfully");
		LOGGER.info("Validate jobs page is loaded successfully");
		...
		LOGGER.info("Verified 'Last 1 hour' option in date picker filter.");
		...
		LOGGER.info("Verified 'Last 2 hour' option in date picker filter.");
		...
		LOGGER.info("Verified 'Last 6 hour' option in date picker filter.");
		...
		LOGGER.info("Verified 'Last 12 hour' option in date picker filter.");
		...
		LOGGER.info("Verified Today option in date picker filter.");
		...
		LOGGER.info("Verified Yesterday option in date picker filter.");
		...
		LOGGER.info("Verified 'Last 7 Days' option in date picker filter.");
		...
		LOGGER.info("Verified 'Last 30 Days' option in date picker filter.");
		...
		LOGGER.info("Verified 'Last 90 Days' option in date picker filter.");
		...
		LOGGER.info("Verified 'Last Month' option in date picker filter.");
		...
		LOGGER.info("Verified 'This Month' option in date picker filter.");
		...
		LOGGER.info("Verified 'Custom Range' option in date picker filter.");
