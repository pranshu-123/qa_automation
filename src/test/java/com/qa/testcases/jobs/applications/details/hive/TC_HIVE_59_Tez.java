...
public class TC_HIVE_59_Tez extends BaseClass {
    ...
    public void VerifyHiveAppsWithTezTags() {
        test = extent.startTest("TC_HIVE_59_Tez.VerifyHiveAppsWithTezTags",
                "Verify that when clicked on Tez parent app as 'Hive' DAG should get loaded");
                        ...
                        if (successAppCount > 0) {
                            ...
                            try {
                                ...
                                Assert.assertTrue(applicationsPageObject.tezDagsDisplayed.getText().trim().toLowerCase().contains("dags"),
                                        "In Tez app details dag section is not loaded successfully ");
                                LOGGER.info("Tez app details with DAG is loaded successfully");
                                test.log(LogStatus.PASS, "Tez app details with DAG is loaded successfully");
