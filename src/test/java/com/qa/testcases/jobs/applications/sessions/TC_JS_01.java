...
@Marker.JobsSessions
public class TC_JS_01 extends BaseClass {
    private static final Logger LOGGER = Logger.getLogger(TC_PWF_05.class.getName());

    @Test(dataProvider = "clusterid-data-provider")
    public void verifyHiveOnMapReduceAppsCount(String clusterId) {
        test = extent.startTest("TC_PWF_05.verifyHiveOnMapReduceAppsCount", "Verify Hive On MapReduce total count of heading.");
        ...
        int appCount = sessionsApps.clickOnlyLink("Hive on MapReduce");
