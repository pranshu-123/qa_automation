...
public class TC_PWF_05 extends BaseClass {
	private static final Logger LOGGER = Logger.getLogger(TC_PWF_05.class.getName());

	@Test
	public void verifyMRWorkflowDetails() {
		test = extent.startTest("TC_PWF_05.verifyMRWorkflowDetails", "Verify MR workflow details in Unravel UI.");
