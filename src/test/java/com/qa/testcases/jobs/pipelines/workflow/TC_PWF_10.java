...
public class TC_PWF_10 extends BaseClass {
	private static final Logger LOGGER = Logger.getLogger(TC_PWF_10.class.getName());

	@Test
	public void verifySparkWorkflowDetails() {
		test = extent.startTest("TC_PWF_10.verifySparkWorkflowDetails", "Verify spark workflow details in Unravel UI.");
		...
		test.log(LogStatus.INFO, "Search for spark workflow and navigate to workflow details page.");
		jobWorkflow.searchWorkflowName(PageConstants.WorkflowName.OOZIE_SPARK_WF);
		try {
