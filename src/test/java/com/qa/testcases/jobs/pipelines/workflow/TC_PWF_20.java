...
public class TC_PWF_20 extends BaseClass {
	private static final Logger LOGGER = Logger.getLogger(TC_PWF_20.class.getName());

	@Test
	public void verifyHive2WorkflowDetails() {
		test = extent.startTest("TC_PWF_20.verifyHiveWorkflowDetails",
				"Verify Hive-2 workflow details in Unravel UI.");
		...
		try {
			jobWorkflow.searchWorkflowName(PageConstants.WorkflowName.OOZIE_HIVE2_WF);
