...
public class TC_PWF_35 extends BaseClass {
	private static final Logger LOGGER = Logger.getLogger(TC_PWF_35.class.getName());

	@Test
	public void verifyHiveSparkWorkflowDetails() {
		test = extent.startTest("TC_PWF_35.verifyHiveWorkflowDetails",
				"Verify Hive-Spark workflow details in Unravel UI.");
		...
		try {
			jobWorkflow.searchWorkflowName(PageConstants.WorkflowName.OOZIE_HIVE_SPARK);
