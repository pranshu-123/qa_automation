...
public class TC_PWF_38 extends BaseClass {
	private static final Logger LOGGER = Logger.getLogger(TC_PWF_38.class.getName());

	@Test
	public void verifyHiveMRDefaultWorkflowDetails() {
		test = extent.startTest("TC_PWF_38.verifyHiveMRDefaultWorkflowDetails",
		...
		try {
			...
			if (workflowPageObject.unknownBadge.size() != 0 || workflowPageObject.successBadge.size() != 0) {
