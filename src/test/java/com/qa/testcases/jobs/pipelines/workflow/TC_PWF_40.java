...
public class TC_PWF_40 extends BaseClass {
	private static final Logger LOGGER = Logger.getLogger(TC_PWF_40.class.getName());

	@Test
	public void verifyTaggedImpalaWorkflowDetails() {
		test = extent.startTest("TC_PWF_40.verifyTaggedImpalaWorkflowDetails", "Verify tagged impala workflow details in Unravel UI.");
		...
		try {
			jobWorkflow.searchWorkflowName(PageConstants.WorkflowName.IMPALA_TAGGED);
			...
			LOGGER.info("The workflow for impala tagged is absent hence skipping the testcase");
			test.log(LogStatus.SKIP, "The workflow for impala tagged is absent hence skipping the testcase");
		}
