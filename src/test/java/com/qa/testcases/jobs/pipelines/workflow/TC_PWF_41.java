...
public class TC_PWF_41 extends BaseClass {
	...
	@Test
	public void verifyOozieTezWorkflowDetails() {
		test = extent.startTest("TC_PWF_41.verifyOozieTezWorkflowDetails",
				"Verify oozie tez workflow details in Unravel UI.");
		...
		try {
			jobWorkflow.searchWorkflowName(PageConstants.WorkflowName.OOZIE_TEZ_WF);
