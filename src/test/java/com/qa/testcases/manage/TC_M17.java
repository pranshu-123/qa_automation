...
@Marker.Manage
public class TC_M17 extends BaseClass {
    Logger LOGGER = LoggerFactory.getLogger(TC_M17.class);
    @Test()
    public void deleteGeneratedApiToken() {
        test = extent.startTest("TC_M17.Delete Generated Token", "Verify" +
