...
@Marker.Manage
public class TC_M21 extends BaseClass {
    Logger LOGGER = LoggerFactory.getLogger(TC_M21.class);

    @Test()
    public void sortApiTokenBasisClientId() {
        test = extent.startTest("TC_M21.sortApiTokenBasisClientId", "Sort Api tokens as per client id");
        ...
        manage.validateSorting("Client Id");
