...
public class TC_CMP_13 extends BaseClass {
    ...
    /**
     * Verify Unravel displays a single AZURE instance for all the hosts in the cluster.
     */
    @Test
    public void verifySingleAzureInstance() {
        test = extent.startTest("TC_CMP_13.verifySingleAzureInstance", "Verify Unravel displays a single AZURE instance" +
