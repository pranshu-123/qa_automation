...
public class TC_CMP_23 extends BaseClass{
    ...
    @Test
    public void verifyGCPCostEffectivenessWithObjectStorage() {
        test = extent.startTest("TC_CMP_23.verifyGCPCostEffectivenessWithObjectStorage", "Verify Unravel recommends the best GCP instance based on max capacity for \"Lift and Shift\" and cluster node usage for \"cost reduction\" when 5 of the instances in Run/Schedule are selected. Make sure that Unravel recommends the most cost effective instance. " +
                "for Object Storage");
        ...
        test.log(LogStatus.PASS, "Validated GCP recommends the most effective instance with Object Storage selected successfully.");
