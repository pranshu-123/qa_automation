...
public class TC_CMP_25 extends BaseClass {
    private final static LoggingUtils LOGGER = new LoggingUtils(TC_CMP_25.class);

    /**
     * Verify Unravel displays a single HDI instance for all the hosts in the cluster.
     */
    @Test
    public void verifySingleHDIInstance() {
        test = extent.startTest("TC_CMP_25.verifySingleHDIInstance", "Verify Unravel displays a single HDI instance " +
