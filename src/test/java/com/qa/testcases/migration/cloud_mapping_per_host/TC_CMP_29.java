...
public class TC_CMP_29 extends BaseClass {
    private final static LoggingUtils LOGGER = new LoggingUtils(TC_CMP_29.class);

    /**
     * Verify Unravel displays a single Dataproc instance for all the hosts in the cluster.
     */
    @Test
    public void verifySingleDataProcInstance() {
        test = extent.startTest("TC_CMP_29.verifySingleDataProcInstance", "Verify Unravel displays a single " +
            "Data Proc instance for all the hosts in the cluster.");
        ...
        LOGGER.info("Select Data Proc as cloud product.", test);
