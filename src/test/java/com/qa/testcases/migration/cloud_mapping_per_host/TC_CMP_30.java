...
@Marker.All
public class TC_CMP_30 extends BaseClass {
    private static final LoggingUtils LOGGER = new LoggingUtils(TC_CMP_30.class);

    /**
     * Verify Unravel recommends the best Dataproc instance based on max capacity for "Lift and Shift" and cluster
     * node usage for "cost reduction" when all the instances in Run/Schedule are selected. Make sure that Unravel
     * recommends the most cost effective instance.
     */

    @Test
    public void verifyBestDataProcInstance() {
        test = extent.startTest("TC_CMP_30.verifyBestDataProcInstance", "Verify Unravel recommends the best Data Proc" +
        ...
        LOGGER.info("Select DataProc as cloud product.", test);
