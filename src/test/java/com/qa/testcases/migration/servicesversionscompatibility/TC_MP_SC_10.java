...
public class TC_MP_SC_10 extends BaseClass {

    private static final Logger LOGGER = Logger.getLogger(TC_MP_SC_10.class.getName());

    @Test(dataProvider = "clusterid-data-provider")
    public void validateServicesAndVersionsAreNotCompatibleForAmazonEMR(String clusterId) {

        test = extent.startTest("TC_MP_SC_10.validateServicesAndVersionsAreNotCompatibleForAmazonEMR: " + clusterId,
                "Validate \"Services and Versions are not Compatible\" legend for cloud provider - \"Amazon EMR\" ");
