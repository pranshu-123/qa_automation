...
public class TC_MP_SC_11 extends BaseClass {

    private static final Logger LOGGER = Logger.getLogger(TC_MP_SC_11.class.getName());

    @Test(dataProvider = "clusterid-data-provider")
    public void validateServicesAndVersionsAreNotCompatibleForAzureHDI(String clusterId) {

        test = extent.startTest("TC_MP_SC_11.validateServicesAndVersionsAreNotCompatibleForAzureHDI: " + clusterId,
                "Validate \"Services and Versions are not Compatible\" legend for cloud provider - \"Azure HDI\" ");
...
//        LOGGER.info("Clicked on close banner");
        ...
        try {
            ...
            test.log(LogStatus.PASS, "Verified Services and Versions are Not Compatible" +
                    " legend for cloud provider Azure HDI.");
