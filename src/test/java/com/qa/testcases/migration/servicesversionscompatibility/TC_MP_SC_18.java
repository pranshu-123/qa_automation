...
public class TC_MP_SC_18 extends BaseClass {
    ...
    public void validateScheduleReportOnDailyBasis(String clusterId) {

        test = extent.startTest("TC_MP_SC_18.validateScheduleReportOnDailyBasis: " + clusterId,
        ...
        String scheduleName = "Serv_Com_An_Test1";
        ...
        Assert.assertTrue(servicesAndVersionsCompatibilityPageObject.scheduleMsg.isDisplayed(),"Not able to " +
                "schedule report");
        test.log(LogStatus.PASS, "Verified schedule report on daily basis is scheduled");
