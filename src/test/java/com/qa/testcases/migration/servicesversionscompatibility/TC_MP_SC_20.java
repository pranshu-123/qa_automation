...
public class TC_MP_SC_20  extends BaseClass {

    private static final Logger LOGGER = Logger.getLogger(TC_MP_SC_20.class.getName());

    @Test(dataProvider = "clusterid-data-provider")
    public void validateScheduleReportOnDailyBasisForAzureHDInsight(String clusterId) {

        test = extent.startTest("TC_MP_SC_20.validateScheduleReportOnDailyBasisForAzureHDInsight: " + clusterId,
...
//        LOGGER.info("Clicked on close banner");
        ...
        String cloudProductName = "Azure HDInsight";
        String scheduleName = "Serv_Com_An_Test1_Azure";
        ...
        Assert.assertTrue(servicesAndVersionsCompatibilityPageObject.scheduleMsg.isDisplayed(),"Not able to " +
                "schedule report");
        test.log(LogStatus.PASS, "Verified schedule report on daily basis is scheduled for Azure HDInsight.");
