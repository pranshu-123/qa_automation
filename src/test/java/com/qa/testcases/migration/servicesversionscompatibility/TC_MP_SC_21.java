...
public class TC_MP_SC_21 extends BaseClass {

    private static final Logger LOGGER = Logger.getLogger(TC_MP_SC_21.class.getName());

    @Test(dataProvider = "clusterid-data-provider")
    public void validateScheduleReportOnceAWeek(String clusterId) {

        test = extent.startTest("TC_MP_SC_21.validateScheduleReportOnceAWeek: " + clusterId,
                " Validate scheduling a report once a week ");
        ...
        String scheduleName = "Serv_Com_An_Test2";
        String schedule_to_Run = "Thursday";
        String scheduleTime = "17:30";
        ...
        Assert.assertTrue(servicesAndVersionsCompatibilityPageObject.scheduleMsg.isDisplayed(),"Not able to " +
                "schedule report");
        test.log(LogStatus.PASS, "Verified schedule report once a week is scheduled for Amazon EMR.");
