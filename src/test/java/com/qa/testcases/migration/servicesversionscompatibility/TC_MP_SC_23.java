...
public class TC_MP_SC_23 extends BaseClass {

    private static final Logger LOGGER = Logger.getLogger(TC_MP_SC_23.class.getName());

    @Test(dataProvider = "clusterid-data-provider")
    public void validateScheduleReportOnceAMonth(String clusterId) {

        test = extent.startTest("TC_MP_SC_23.validateScheduleReportOnceAMonth: " + clusterId,
                " Validate scheduling a report once in a month ");
...
//        LOGGER.info("Clicked on close banner");
        ...
        String scheduleName = "Serv_Com_An_Test4";
        String schedule_to_Run = "Every Month";
        ...
        Assert.assertTrue(servicesAndVersionsCompatibilityPageObject.scheduleMsg.isDisplayed(),"Not able to " +
                "schedule report");
        test.log(LogStatus.PASS, "Verified schedule report once a month is scheduled for Azure HDI.");
