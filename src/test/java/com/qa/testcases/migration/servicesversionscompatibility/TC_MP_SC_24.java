...
public class TC_MP_SC_24 extends BaseClass {

    private static final Logger LOGGER = Logger.getLogger(TC_MP_SC_24.class.getName());

    @Test(dataProvider = "clusterid-data-provider")
    public void validateScheduleReportNameWithSpecialChars(String clusterId) {

        test = extent.startTest("TC_MP_SC_24.validateScheduleReportNameWithSpecialChars: " + clusterId,
                " Schedule Name with special characters ");
        ...
        Assert.assertTrue(servicesAndVersionsCompatibilityPageObject.scheduleMsg.isDisplayed(),"Not able to " +
                "schedule report");
        test.log(LogStatus.PASS, "Verified schedule report with special characters is scheduled for Azure HDI.");
