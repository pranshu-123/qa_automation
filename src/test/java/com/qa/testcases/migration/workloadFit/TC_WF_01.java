...
@Marker.WorkloadFit
@Marker.All
public class TC_WF_01 extends BaseClass {
    private static final Logger LOGGER = Logger.getLogger(TC_WF_01.class.getName());

    @Test
    public void validateJobType() {
        test = extent.startTest("TC_WF_01.validateJobType",
                "Verify that Unravel UI should generate a Workload Fit report and Job Type pie-chart should be displayed.");
