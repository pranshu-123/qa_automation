...
@Marker.WorkloadFit
@Marker.All
public class TC_WF_06 extends BaseClass {
    private static final Logger LOGGER = Logger.getLogger(TC_WF_06.class.getName());

    @Test
    public void validateHeatMapJobCount() {
        test = extent.startTest("TC_WF_06.validateHeatMapMemory",
                "Verify that Unravel UI should generate Heat Map for Memory.");
        ...
        fit.selectHeatMapTypeFromDropdown("ms");
