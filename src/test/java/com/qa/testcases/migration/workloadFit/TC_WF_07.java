...
@Marker.WorkloadFit
@Marker.All
public class TC_WF_07 extends BaseClass {
    private static final Logger LOGGER = Logger.getLogger(TC_WF_07.class.getName());

    @Test
    public void validateHeatMapVCores() {
        test = extent.startTest("TC_WF_07.validateHeatMapVCores",
                "Verify that Unravel UI should generate Heat Map for VCores.");
        ...
        fit.selectHeatMapTypeFromDropdown("vs");
        ...
        try {
            Assert.assertTrue(fitPageObject.heatMapHighchart.isDisplayed(),
                    "The heat map didnt get genrated for Vcores");
            test.log(LogStatus.PASS, "Heat map generated for Vcores.");
