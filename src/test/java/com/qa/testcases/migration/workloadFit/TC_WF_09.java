...
@Marker.WorkloadFit
@Marker.All
public class TC_WF_09 extends BaseClass {
    private static final Logger LOGGER = Logger.getLogger(TC_WF_09.class.getName());

    @Test
    public void validateMapToSingleCluster() {
        test = extent.startTest("TC_WF_09.validateMapToMultiCluster",
                "Verify that Unravel UI should generate a Workload Fit report having map to multiple cluster.");
